...
namespace csman {
    namespace core {
        enum class source_content_type {
            UNKNOWN, BIN, DLL, CSE, CSP, ZIP, DOC,
        };
        ...
        struct source_package_version_info final {
            std::string _name;
            std::string _owner_package;
        ...
        struct source_package_info final {
            ...
            std::unordered_map<std::string, source_package_version_info> _versions;
        };
